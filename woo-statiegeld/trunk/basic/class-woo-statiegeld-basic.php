 ...
 * @subpackage Woo_Statiegeld/basic
 */
...
class Woo_Statiegeld_Basic {
	 ...
	 *
	 * @since    1.0.0
	 * @var      string    $woo_statiegeld       The name of the plugin.
    ...
    function add_deposit_value_to_totals() {
        ...
        if( $dep_total > 0 )
            $woocommerce->cart->add_fee( __( 'Totaal statiegeld', $this->woo_statiegeld ), $dep_total, $tax, $tax_class );
